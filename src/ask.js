...
const ASK_SUGG = [
  ...
  { q: "Can flexible load defer the Feeder F-2231 upgrade?", src: [["gear", "Flexible load calculation"], ["pin", "Meter-to-asset aggregation"]],
    rows: [["EV managed charging", 1.4], ["Smart thermostats", 0.9], ["Pool pumps", 0.3], ["Home batteries", 0.2]], unit: " MW",
    text: "Likely yes. F-2231 is forecast to run 2.1 MW over its rating at 6pm by 2029, and homes on the feeder can shift 2.8 MW in that window, led by EV managed charging at 1.4 MW. Enrolling about 60% of it covers the gap and defers the upgrade roughly three years.\nLINKS: uc:nws, uc:flex" },
];
